...
class ShippingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($status) {
            return redirect()->route('shipping.index')->with('success', 'Shipping create successfully');
        } else {
    ...
    public function edit($id)
    {
        ...
        if ($shipping) {
            ...
            return back()->with('error', 'Shipping no found');
        }
    }
    ...
    public function destroy($id)
    {
        ...
        if ($shipping) {
            ...
            if ($status){
                return redirect()->route('shipping.index')->with('success', 'Shipping delete successfully');
            }
        } else {
            return back()->with('error', 'Something went wrong');
        }
