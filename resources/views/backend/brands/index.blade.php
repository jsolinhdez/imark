                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class=" card-title">All Brands
                                    <a class="btn ml-2 btn-outline-secondary" href=" {{ route('brand.create') }}"><i
                                            class="mr-1 icon-plus"></i>Add Brand</a></h3>

                                <p class="float-right">Total Brands: <strong>{{ \App\Models\Brand::count() }}</strong>
                                </p>
